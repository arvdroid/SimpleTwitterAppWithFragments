package com.codepath.apps.simpletwitter.listener;
...
public class TimeLineTabListener<T extends Fragment> implements TabListener {
	...
	public TimeLineTabListener(FragmentActivity activity, String tag, Class<T> clz) {
		mActivity = activity;
		mTag = tag;
		mClass = clz;
	...
	public TimeLineTabListener(int fragmentContainerId, FragmentActivity activity, 
	...
	public void onTabSelected(Tab tab, android.app.FragmentTransaction ft) {
		...
		if (mFragment == null) {
	        ...
	        args.putString("parentActivity", "DetailedTweetActivity");
